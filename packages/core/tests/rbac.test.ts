...
describe('RBAC matrix v1.5 (machine-readable, QA AC-RBAC-1/2)', () => {
  it('covers all 45 actions x 3 roles with explicit cells (v1.5: 27 + 18 additive, TL §M)', () => {
    expect(ALL_ACTIONS.length).toBe(45);

...
export const SEED_BOOKKEEPING_TABLES: readonly string[] = ['contake_db_identity', 'schema_migrations', 'schema_migration_evidence', 'schema_migration_acks', 'schema_migration_target_state', 'staging_seed_state'];

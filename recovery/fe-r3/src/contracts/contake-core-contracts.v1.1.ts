/**
 * @contake/core — Shared contracts v1.1 (2026-09-11)
...
export interface DominoResult {
  ...
  summaryHe: string;          // e.g. "אפקט דומינו: 1 משימות תלויות יזוזו (בריכה)"
}
...
export type NotificationKind = 'task_delayed' | 'task_moved' | 'task_cancelled' | 'change_needs_approval';
...
export type AuditEntityType = NodeKind | 'user' | 'change_request' | 'notification';
 ...
 *   server -> client: 'graph.patch' { tasks: TaskNode[] }, 'change.pending' ChangeRequest,
